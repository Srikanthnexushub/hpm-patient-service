...
import { createPrescription } from '../api/pharmacyApi'
  ...
  return (
    <div className="max-w-lg mx-auto">
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mt-2">New Prescription</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
        ...
        <div>
          ...
          <input
            name="patientId" value={form.patientId} onChange={handleChange} required
        ...
        <div>
          ...
          <input
            name="doctorId" value={form.doctorId} onChange={handleChange} required
        ...
        <div className="flex gap-3 pt-2">
          ...
          <button
            type="button" onClick={() => navigate('/prescriptions')}
